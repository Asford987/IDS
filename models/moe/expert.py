...
class ExpertPretrainDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = ExpertPretrainDataset(self.train_path, self.test_path, self.binarize_on_label)
        self.test_dataset = ExpertPretrainDataset(self.test_path, self.test_path, self.binarize_on_label)
...
class ExpertModel(pl.LightningModule):
    def __init__(self, input_dim, hidden_units, dropout_rate=0.0, learning_rate=1e-3, alpha=1.0, beta=1.0):
